...
BINARY="https://github.com/Sifchain/sifnode/releases/download/v0.13.4/sifnoded-v0.13.4-linux-amd64.zip"
GENESIS="https://raw.githubusercontent.com/Sifchain/networks/master/betanet/sifchain-1/genesis.json"
DAEMON_HOME="$HOME/.sifnoded"
DAEMON_NAME="sifnoded"
BINARYNAME="sifnoded"
DOWNLOADNAME="sifnoded-v0.13.4-linux-amd64.zip"
CHAINID="sifchain-1"
