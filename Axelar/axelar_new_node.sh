...
REPODIRECTORY="$HOME/axelar-core"
GENESIS="https://axelar-mainnet.s3.us-east-2.amazonaws.com/genesis.json"
BINARYNAME="axelard"
VERSION="v0.33.0"
DAEMON_HOME="$HOME/.axelar"
CHAINID="axelar-dojo-1"
SEEDS=""
RPC1="https://axelar-rpc.ibs.team"
RPC_PORT1=443
INTERVAL=1000
GOVERSION="1.19.5"
...
sleep 2
  ...
  make build
  cd ~
  cp axelar-core/bin/axelard $HOME/go/bin
